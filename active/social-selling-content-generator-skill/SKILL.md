...
<objective>
Turn LinkedIn into a lead generation machine with AI-powered content. Creates a 30-day content calendar of thought leadership posts, comment strategies, and engagement tactics that position you as an authority and generate inbound interest from target prospects.
</objective>

<quick_start>
**Trigger:** "Generate LinkedIn content for social selling" or "Create 30 days of LinkedIn posts"
**Input:** Target audience (job titles), your solution, content goal, posting frequency
**Output:** 30-day content calendar with posts, comment strategies, engagement tactics, and persona-specific templates
</quick_start>

<success_criteria>
- [ ] 30-day content calendar with 3-5 posts per week
...
- [ ] Persona-specific content templates provided
...
[Specific data points showing old vs. new]

What's working for you in 2024?

**Why This Works**: Credible authority signal, contrarian take, specific data, question drives comments
...
[Story arc: what happened → what went wrong → lesson learned]

What's your biggest lesson from a lost deal?

**Why This Works**: Vulnerable, relatable pain, actionable lesson, invites shared experiences
...
### For VPs of Sales
- **Problems**: Forecast accuracy, quota attainment, rep ramp time, pipeline coverage
- **Stories**: Scaling teams, turning around underperformance, building process
- **How-To**: Implementing methodology, onboarding reps, improving win rates

### For CTOs/VPs Engineering
- **Problems**: Developer productivity, tech debt, hiring, infrastructure costs
- **Stories**: Migration experiences, team building, technical decisions
- **How-To**: Evaluating tools, building culture, managing technical debt
