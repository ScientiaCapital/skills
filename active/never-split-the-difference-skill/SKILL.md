...
**Example:** `Prepare negotiation strategy for $50K AV deal where prospect says budget is $30K`
</quick_start>
...
- "You're right" = They want you to stop talking → You've lost them
</core_techniques>
...
5. One question at a time — stacking kills depth
</calibrated_questions>
...
[Signature]
```
This is Chris Voss's single highest-response-rate email template.
</the_no_framework>
