---
name: inbound-lead-qualifier-skill
...
<objective>
Analyze inbound leads (form fills, demo requests, content downloads) and score them on ICP fit (0-40), intent (0-30), and urgency (0-30) for a total 0-100 score. Auto-generates qualification questions, routes to the right rep with full context, and provides personalized first-touch call scripts and email templates for immediate follow-up.
</objective>

<quick_start>
**Trigger:** "Qualify this inbound lead" or "Score and route [lead name] from [company]"
**Input:** Lead name, company, source (form/demo request), any form data or engagement history
**Output:** Lead score (0-100) with priority tier, qualification questions, call script, email template, routing recommendation, and next steps
</quick_start>

<success_criteria>
- [ ] Lead scored on ICP Fit + Intent + Urgency (0-100 total)
- [ ] Priority tier assigned (Hot/Warm/Cool/Nurture) with response SLA
- [ ] Rep routing recommendation with reasoning
- [ ] Qualification questions generated (must-ask + good-to-ask)
- [ ] Call script and email template provided
- [ ] Similar customer examples and competitive intel included
</success_criteria>
